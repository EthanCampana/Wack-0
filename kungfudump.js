...
urls = [
'https://www.imdb.com/list/ls002939147/?ref_=rltls_82',
'https://www.imdb.com/list/ls002939147/?ref_=rltls_82&sort=list_order,asc&st_dt=&mode=detail&page=2',
'https://www.imdb.com/list/ls002939147/?ref_=rltls_82&sort=list_order,asc&st_dt=&mode=detail&page=3',
'https://www.imdb.com/list/ls002939147/?ref_=rltls_82&sort=list_order,asc&st_dt=&mode=detail&page=4',
'https://www.imdb.com/list/ls002939147/?ref_=rltls_82&sort=list_order,asc&st_dt=&mode=detail&page=5'
]
...
for(let z = 0; z < urls.length; z++){
    getMovies(urls[z]).then(res => {
        ...
        fs.writeFileSync(__dirname +'/kungfu.json', data);
